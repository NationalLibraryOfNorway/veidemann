...
public class Settings extends CommonSettings {
    ...
    public String getTrustedCaCertPath() {
        return trustedCaCertPath;
    }

    public void setTrustedCaCertPath(String trustedCaCertPath) {
    ...
    public void setAstServiceUrl(String astServiceUrl) {
        this.astServiceUrl = astServiceUrl;
    }
