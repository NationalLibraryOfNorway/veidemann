...
func (x *CrawlLogListRequest) GetQueryMask() *commons.FieldMask {
	if x != nil {
		return x.QueryMask
	}
	return nil
...
func (x *CrawlLogListRequest) GetReturnedFieldsMask() *commons.FieldMask {
	if x != nil {
...
func (x *PageLogListRequest) GetQueryMask() *commons.FieldMask {
	if x != nil {
		return x.QueryMask
	}
	return nil
...
func (x *PageLogListRequest) GetReturnedFieldsMask() *commons.FieldMask {
	if x != nil {
		return x.ReturnedFieldsMask
	}
	return nil
...
var file_log_v1_log_proto_rawDesc = []byte{
	...
	0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x00, 0x28, 0x01, 0x42, 0x64, 0x0a, 0x1e, 0x6e,
	...
	0x6f, 0x67, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x50, 0x01, 0x5a, 0x34, 0x67, 0x69, 0x74,
	...
	0x76, 0x65, 0x69, 0x64, 0x65, 0x6d, 0x61, 0x6e, 0x6e, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x6c, 0x6f,
...
var file_log_v1_log_proto_goTypes = []interface{}{
	...
	(*commons.FieldMask)(nil),    // 5: veidemann.api.commons.v1.FieldMask
