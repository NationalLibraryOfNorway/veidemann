...
type CrawlLog struct {
	...
	Error               *commons.Error         `protobuf:"bytes,21,opt,name=error,proto3" json:"error,omitempty"`      // Contains the error reason if fetch failed
...
func (x *CrawlLog) GetError() *commons.Error {
	if x != nil {
		return x.Error
	}
	return nil
...
type PageLog_Resource struct {
	...
	Referrer      string         `protobuf:"bytes,9,opt,name=referrer,proto3" json:"referrer,omitempty"`
	Error         *commons.Error `protobuf:"bytes,10,opt,name=error,proto3" json:"error,omitempty"`   // Contains the error reason if fetch failed
...
func (x *PageLog_Resource) GetError() *commons.Error {
	if x != nil {
		return x.Error
	}
	return nil
...
var file_log_v1_resources_proto_rawDesc = []byte{
	...
	0x42, 0x66, 0x0a, 0x1e, 0x6e, 0x6f, 0x2e, 0x6e, 0x62, 0x2e, 0x6e, 0x6e, 0x61, 0x2e, 0x76, 0x65,
	...
	0x50, 0x01, 0x5a, 0x34, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x4e,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x4c, 0x69, 0x62, 0x72, 0x61, 0x72, 0x79, 0x4f, 0x66,
	0x4e, 0x6f, 0x72, 0x77, 0x61, 0x79, 0x2f, 0x76, 0x65, 0x69, 0x64, 0x65, 0x6d, 0x61, 0x6e, 0x6e,
	0x2f, 0x61, 0x70, 0x69, 0x2f, 0x6c, 0x6f, 0x67, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_log_v1_resources_proto_goTypes = []interface{}{
	...
	(*commons.Error)(nil),         // 4: veidemann.api.commons.v1.Error
}
