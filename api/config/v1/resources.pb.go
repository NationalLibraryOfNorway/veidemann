...
func (x *ConfigObject) GetSpec() isConfigObject_Spec {
	if x != nil {
		return x.Spec
	}
	return nil
...
func (x *ConfigObject) GetCrawlEntity() *CrawlEntity {
	if x != nil {
		if x, ok := x.Spec.(*ConfigObject_CrawlEntity); ok {
...
func (x *ConfigObject) GetSeed() *Seed {
	if x != nil {
		if x, ok := x.Spec.(*ConfigObject_Seed); ok {
			return x.Seed
		}
	}
	return nil
...
func (x *ConfigObject) GetCrawlJob() *CrawlJob {
	if x != nil {
		if x, ok := x.Spec.(*ConfigObject_CrawlJob); ok {
			return x.CrawlJob
		}
	}
	return nil
...
func (x *ConfigObject) GetCrawlConfig() *CrawlConfig {
	if x != nil {
		if x, ok := x.Spec.(*ConfigObject_CrawlConfig); ok {
...
func (x *ConfigObject) GetCrawlScheduleConfig() *CrawlScheduleConfig {
	if x != nil {
		if x, ok := x.Spec.(*ConfigObject_CrawlScheduleConfig); ok {
...
func (x *ConfigObject) GetBrowserConfig() *BrowserConfig {
	if x != nil {
		if x, ok := x.Spec.(*ConfigObject_BrowserConfig); ok {
...
func (x *ConfigObject) GetPolitenessConfig() *PolitenessConfig {
	if x != nil {
		if x, ok := x.Spec.(*ConfigObject_PolitenessConfig); ok {
...
func (x *ConfigObject) GetBrowserScript() *BrowserScript {
	if x != nil {
		if x, ok := x.Spec.(*ConfigObject_BrowserScript); ok {
...
func (x *ConfigObject) GetCrawlHostGroupConfig() *CrawlHostGroupConfig {
	if x != nil {
		if x, ok := x.Spec.(*ConfigObject_CrawlHostGroupConfig); ok {
...
func (x *ConfigObject) GetRoleMapping() *RoleMapping {
	if x != nil {
		if x, ok := x.Spec.(*ConfigObject_RoleMapping); ok {
...
func (x *ConfigObject) GetCollection() *Collection {
	if x != nil {
		if x, ok := x.Spec.(*ConfigObject_Collection); ok {
			return x.Collection
		}
	}
	return nil
...
type BrowserConfig struct {
	...
	ScriptParameters map[string]string `protobuf:"bytes,17,rep,name=script_parameters,json=scriptParameters,proto3" json:"script_parameters,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // Not implemented
...
func (x *RoleMapping) GetEmailOrGroup() isRoleMapping_EmailOrGroup {
	if x != nil {
		return x.EmailOrGroup
	}
	return nil
}
...
func (x *RoleMapping) GetApiKey() *ApiKey {
	if x != nil {
		if x, ok := x.EmailOrGroup.(*RoleMapping_ApiKey); ok {
			return x.ApiKey
		}
	}
	return nil
...
func (x *RoleMapping) GetEmail() string {
	if x != nil {
		if x, ok := x.EmailOrGroup.(*RoleMapping_Email); ok {
			return x.Email
		}
	}
	return ""
...
func (x *RoleMapping) GetGroup() string {
	if x != nil {
		if x, ok := x.EmailOrGroup.(*RoleMapping_Group); ok {
			return x.Group
		}
	}
	return ""
...
const file_config_v1_resources_proto_rawDesc = "" +
	"\n" +
	"\x19config/v1/resources.proto\x12\x17veidemann.api.config.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\x93\b\n" +
	"\fConfigObject\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1e\n" +
	"\n" +
	"apiVersion\x18\x02 \x01(\tR\n" +
	"apiVersion\x121\n" +
	"\x04kind\x18\x03 \x01(\x0e2\x1d.veidemann.api.config.v1.KindR\x04kind\x121\n" +
	"\x04meta\x18\x04 \x01(\v2\x1d.veidemann.api.config.v1.MetaR\x04meta\x12I\n" +
	"\fcrawl_entity\x18\x05 \x01(\v2$.veidemann.api.config.v1.CrawlEntityH\x00R\vcrawlEntity\x123\n" +
	"\x04seed\x18\x06 \x01(\v2\x1d.veidemann.api.config.v1.SeedH\x00R\x04seed\x12@\n" +
	"\tcrawl_job\x18\a \x01(\v2!.veidemann.api.config.v1.CrawlJobH\x00R\bcrawlJob\x12I\n" +
	"\fcrawl_config\x18\b \x01(\v2$.veidemann.api.config.v1.CrawlConfigH\x00R\vcrawlConfig\x12b\n" +
	"\x15crawl_schedule_config\x18\t \x01(\v2,.veidemann.api.config.v1.CrawlScheduleConfigH\x00R\x13crawlScheduleConfig\x12O\n" +
	"\x0ebrowser_config\x18\n" +
	" \x01(\v2&.veidemann.api.config.v1.BrowserConfigH\x00R\rbrowserConfig\x12X\n" +
	"\x11politeness_config\x18\v \x01(\v2).veidemann.api.config.v1.PolitenessConfigH\x00R\x10politenessConfig\x12O\n" +
	"\x0ebrowser_script\x18\f \x01(\v2&.veidemann.api.config.v1.BrowserScriptH\x00R\rbrowserScript\x12f\n" +
	"\x17crawl_host_group_config\x18\r \x01(\v2-.veidemann.api.config.v1.CrawlHostGroupConfigH\x00R\x14crawlHostGroupConfig\x12I\n" +
	"\frole_mapping\x18\x0e \x01(\v2$.veidemann.api.config.v1.RoleMappingH\x00R\vroleMapping\x12E\n" +
	"\n" +
	"collection\x18\x0f \x01(\v2#.veidemann.api.config.v1.CollectionH\x00R\n" +
	"collectionB\x06\n" +
	"\x04spec\"\xf7\x02\n" +
	"\x04Meta\x12\x12\n" +
	...
	"\x10last_modified_by\x18\x06 \x01(\tR\x0elastModifiedBy\x124\n" +
	"\x05label\x18\a \x03(\v2\x1e.veidemann.api.config.v1.LabelR\x05label\x12C\n" +
	"\n" +
	"annotation\x18\b \x03(\v2#.veidemann.api.config.v1.AnnotationR\n" +
	"annotation\"/\n" +
	"\x05Label\x12\x10\n" +
	...
	"\vCrawlEntity\"\xa2\x01\n" +
	"\x04Seed\x12A\n" +
	"\n" +
	"entity_ref\x18\x03 \x01(\v2\".veidemann.api.config.v1.ConfigRefR\tentityRef\x12;\n" +
	"\ajob_ref\x18\x05 \x03(\v2\".veidemann.api.config.v1.ConfigRefR\x06jobRef\x12\x1a\n" +
	"\bdisabled\x18\x12 \x01(\bR\bdisabled\"\xcd\x02\n" +
	"\bCrawlJob\x12E\n" +
	"\fschedule_ref\x18\x03 \x01(\v2\".veidemann.api.config.v1.ConfigRefR\vscheduleRef\x12B\n" +
	"\x06limits\x18\x04 \x01(\v2*.veidemann.api.config.v1.CrawlLimitsConfigR\x06limits\x12L\n" +
	"\x10crawl_config_ref\x18\x05 \x01(\v2\".veidemann.api.config.v1.ConfigRefR\x0ecrawlConfigRef\x12L\n" +
	"\x10scope_script_ref\x18\x06 \x01(\v2\".veidemann.api.config.v1.ConfigRefR\x0escopeScriptRef\x12\x1a\n" +
	"\bdisabled\x18\x12 \x01(\bR\bdisabled\"\x85\x03\n" +
	"\vCrawlConfig\x12I\n" +
	"\x0ecollection_ref\x18\x06 \x01(\v2\".veidemann.api.config.v1.ConfigRefR\rcollectionRef\x12P\n" +
	"\x12browser_config_ref\x18\a \x01(\v2\".veidemann.api.config.v1.ConfigRefR\x10browserConfigRef\x12I\n" +
	"\x0epoliteness_ref\x18\b \x01(\v2\".veidemann.api.config.v1.ConfigRefR\rpolitenessRef\x12:\n" +
	"\x05extra\x18\t \x01(\v2$.veidemann.api.config.v1.ExtraConfigR\x05extra\x12)\n" +
	"\x11minimum_dns_ttl_s\x18\n" +
	" \x01(\x05R\x0eminimumDnsTtlS\x12'\n" +
	"\x0fpriority_weight\x18\v \x01(\x01R\x0epriorityWeight\":\n" +
	"\vExtraConfig\x12+\n" +
	"\x11create_screenshot\x18\x06 \x01(\bR\x10createScreenshot\"\xb0\x01\n" +
	"\x13CrawlScheduleConfig\x12'\n" +
	"\x0fcron_expression\x18\x03 \x01(\tR\x0ecronExpression\x129\n" +
	"\n" +
	"valid_from\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\tvalidFrom\x125\n" +
	"\bvalid_to\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\avalidTo\"V\n" +
	"\x11CrawlLimitsConfig\x12$\n" +
	"\x0emax_duration_s\x18\x02 \x01(\x03R\fmaxDurationS\x12\x1b\n" +
	"\tmax_bytes\x18\x03 \x01(\x03R\bmaxBytes\"\x83\x05\n" +
	"\rBrowserConfig\x12\x1d\n" +
	"\n" +
	...
	"\x14page_load_timeout_ms\x18\x06 \x01(\x03R\x11pageLoadTimeoutMs\x12'\n" +
	"\x0fscript_selector\x18\a \x03(\tR\x0escriptSelector\x12A\n" +
	"\n" +
	"script_ref\x18\b \x03(\v2\".veidemann.api.config.v1.ConfigRefR\tscriptRef\x12M\n" +
	"\aheaders\x18\x10 \x03(\v23.veidemann.api.config.v1.BrowserConfig.HeadersEntryR\aheaders\x12i\n" +
	"\x11script_parameters\x18\x11 \x03(\v2<.veidemann.api.config.v1.BrowserConfig.ScriptParametersEntryR\x10scriptParameters\x123\n" +
	"\x16max_inactivity_time_ms\x18\x12 \x01(\x03R\x13maxInactivityTimeMs\x1a:\n" +
	...
	"\fRobotsPolicy\x12\x0f\n" +
	"\vOBEY_ROBOTS\x10\x00\x12\x11\n" +
	"\rIGNORE_ROBOTS\x10\x01\x12\x11\n" +
	"\rCUSTOM_ROBOTS\x10\x02\x12\x17\n" +
	"\x13OBEY_ROBOTS_CLASSIC\x10\x03\x12\x19\n" +
	"\x15CUSTOM_ROBOTS_CLASSIC\x10\x04\x12\x15\n" +
	"\x11CUSTOM_IF_MISSING\x10\x05\x12\x1d\n" +
	"\x19CUSTOM_IF_MISSING_CLASSIC\x10\x06\"\xae\x02\n" +
	"\rBrowserScript\x12\x16\n" +
	"\x06script\x18\x03 \x01(\tR\x06script\x12\x1d\n" +
	"\n" +
	"url_regexp\x18\x04 \x03(\tR\turlRegexp\x12h\n" +
	"\x13browser_script_type\x18\x05 \x01(\x0e28.veidemann.api.config.v1.BrowserScript.BrowserScriptTypeR\x11browserScriptType\"|\n" +
	"\x11BrowserScriptType\x12\r\n" +
	"\tUNDEFINED\x10\x00\x12\x14\n" +
	"\x10EXTRACT_OUTLINKS\x10\x01\x12\x0f\n" +
	"\vREPLACEMENT\x10\x02\x12\v\n" +
	"\aON_LOAD\x10\x03\x12\x13\n" +
	"\x0fON_NEW_DOCUMENT\x10\x04\x12\x0f\n" +
	"\vSCOPE_CHECK\x10\x05\"\x97\x03\n" +
	"\x14CrawlHostGroupConfig\x12P\n" +
	"\bip_range\x18\x03 \x03(\v25.veidemann.api.config.v1.CrawlHostGroupConfig.IpRangeR\aipRange\x12?\n" +
	"\x1dmin_time_between_page_load_ms\x18\x04 \x01(\x03R\x18minTimeBetweenPageLoadMs\x12?\n" +
	"\x1dmax_time_between_page_load_ms\x18\x05 \x01(\x03R\x18maxTimeBetweenPageLoadMs\x12!\n" +
	"\fdelay_factor\x18\x06 \x01(\x02R\vdelayFactor\x12\x1f\n" +
	"\vmax_retries\x18\a \x01(\x05R\n" +
	"maxRetries\x12.\n" +
	"\x13retry_delay_seconds\x18\b \x01(\x05R\x11retryDelaySeconds\x1a7\n" +
	"\aIpRange\x12\x17\n" +
	"\aip_from\x18\x01 \x01(\tR\x06ipFrom\x12\x13\n" +
	"\x05ip_to\x18\x02 \x01(\tR\x04ipTo\"Z\n" +
	"\x06ApiKey\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x12:\n" +
	"\n" +
	"validUntil\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"validUntil\"\xbe\x01\n" +
	"\vRoleMapping\x12:\n" +
	"\aapi_key\x18\x01 \x01(\v2\x1f.veidemann.api.config.v1.ApiKeyH\x00R\x06apiKey\x12\x16\n" +
	"\x05email\x18\x02 \x01(\tH\x00R\x05email\x12\x16\n" +
	"\x05group\x18\x03 \x01(\tH\x00R\x05group\x121\n" +
	"\x04role\x18\x04 \x03(\x0e2\x1d.veidemann.api.config.v1.RoleR\x04roleB\x10\n" +
	"\x0eemail_or_group\"\xec\x04\n" +
	"\n" +
	"Collection\x12j\n" +
	"\x17collection_dedup_policy\x18\x01 \x01(\x0e22.veidemann.api.config.v1.Collection.RotationPolicyR\x15collectionDedupPolicy\x12d\n" +
	"\x14file_rotation_policy\x18\x02 \x01(\x0e22.veidemann.api.config.v1.Collection.RotationPolicyR\x12fileRotationPolicy\x12\x1a\n" +
	"\bcompress\x18\x03 \x01(\bR\bcompress\x12\x1b\n" +
	"\tfile_size\x18\x04 \x01(\x03R\bfileSize\x12Z\n" +
	"\x0fsub_collections\x18\n" +
	" \x03(\v21.veidemann.api.config.v1.Collection.SubCollectionR\x0esubCollections\x1an\n" +
	"\rSubCollection\x12I\n" +
	"\x04type\x18\x01 \x01(\x0e25.veidemann.api.config.v1.Collection.SubCollectionTypeR\x04type\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\"J\n" +
	"\x0eRotationPolicy\x12\b\n" +
	"\x04NONE\x10\x00\x12\n" +
	"\n" +
	"\x06HOURLY\x10\x01\x12\t\n" +
	"\x05DAILY\x10\x02\x12\v\n" +
	"\aMONTHLY\x10\x03\x12\n" +
	"\n" +
	"\x06YEARLY\x10\x04\";\n" +
	"\x11SubCollectionType\x12\r\n" +
	"\tUNDEFINED\x10\x00\x12\x0e\n" +
	"\n" +
	"SCREENSHOT\x10\x01\x12\a\n" +
	"\x03DNS\x10\x02\"\xa3\x02\n" +
	"\tLogLevels\x12H\n" +
	"\tlog_level\x18\x01 \x03(\v2+.veidemann.api.config.v1.LogLevels.LogLevelR\blogLevel\x1ab\n" +
	"\bLogLevel\x12\x16\n" +
	"\x06logger\x18\x01 \x01(\tR\x06logger\x12>\n" +
	"\x05level\x18\x02 \x01(\x0e2(.veidemann.api.config.v1.LogLevels.LevelR\x05level\"h\n" +
	"\x05Level\x12\r\n" +
	...
	"\x03OFF\x10\b*\xdf\x01\n" +
	"\x04Kind\x12\r\n" +
	"\tundefined\x10\x00\x12\x0f\n" +
	"\vcrawlEntity\x10\x05\x12\b\n" +
	"\x04seed\x10\x06\x12\f\n" +
	"\bcrawlJob\x10\a\x12\x0f\n" +
	"\vcrawlConfig\x10\b\x12\x17\n" +
	"\x13crawlScheduleConfig\x10\t\x12\x11\n" +
	"\rbrowserConfig\x10\n" +
	"\x12\x14\n" +
	"\x10politenessConfig\x10\v\x12\x11\n" +
	"\rbrowserScript\x10\f\x12\x18\n" +
	"\x14crawlHostGroupConfig\x10\r\x12\x0f\n" +
	"\vroleMapping\x10\x0e\x12\x0e\n" +
	"\n" +
	"collection\x10\x0f*m\n" +
	"\x04Role\x12\f\n" +
	"\bANY_USER\x10\x00\x12\a\n" +
	"\x03ANY\x10\x01\x12\t\n" +
	"\x05ADMIN\x10\x02\x12\v\n" +
	"\aCURATOR\x10\x03\x12\f\n" +
	"\bREADONLY\x10\x04\x12\f\n" +
	"\bOPERATOR\x10\x05\x12\n" +
	"\n" +
	"\x06SYSTEM\x10\x06\x12\x0e\n" +
	"\n" +
	"CONSULTANT\x10\aB\xe8\x01\n" +
	"\x1bcom.veidemann.api.config.v1B\x0eResourcesProtoP\x01Z:github.com/NationalLibraryOfNorway/veidemann/api/config/v1\xa2\x02\x03VAC\xaa\x02\x17Veidemann.Api.Config.V1\xca\x02\x17Veidemann\\Api\\Config\\V1\xe2\x02#Veidemann\\Api\\Config\\V1\\GPBMetadata\xea\x02\x1aVeidemann::Api::Config::V1b\x06proto3"

var (
	file_config_v1_resources_proto_rawDescOnce sync.Once
	file_config_v1_resources_proto_rawDescData []byte
)

func file_config_v1_resources_proto_rawDescGZIP() []byte {
	file_config_v1_resources_proto_rawDescOnce.Do(func() {
		file_config_v1_resources_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_config_v1_resources_proto_rawDesc), len(file_config_v1_resources_proto_rawDesc)))
	})
...
var file_config_v1_resources_proto_goTypes = []any{
...
func file_config_v1_resources_proto_init() {
	...
	file_config_v1_resources_proto_msgTypes[0].OneofWrappers = []any{
	...
	file_config_v1_resources_proto_msgTypes[17].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_config_v1_resources_proto_rawDesc), len(file_config_v1_resources_proto_rawDesc)),
			NumEnums:      7,
			NumMessages:   25,
			NumExtensions: 0,
			NumServices:   0,
