...
// All implementations should embed UnimplementedDnsResolverServer
...
// UnimplementedDnsResolverServer should be embedded to have
...
func RegisterDnsResolverServer(s grpc.ServiceRegistrar, srv DnsResolverServer) {
	// If the following call panics, it indicates UnimplementedDnsResolverServer was
