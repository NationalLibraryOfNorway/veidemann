...
// All implementations should embed UnimplementedContentWriterServer
...
// UnimplementedContentWriterServer should be embedded to have
...
func RegisterContentWriterServer(s grpc.ServiceRegistrar, srv ContentWriterServer) {
	// If the following call panics, it indicates UnimplementedContentWriterServer was
