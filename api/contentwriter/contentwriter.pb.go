...
func (x *WriteRequestMeta) GetCollectionRef() *config.ConfigRef {
	if x != nil {
...
type WriteRequestMeta_RecordMeta struct {
	...
	SubCollection     config.Collection_SubCollectionType `protobuf:"varint,7,opt,name=sub_collection,json=subCollection,proto3,enum=veidemann.api.config.v1.Collection_SubCollectionType" json:"sub_collection,omitempty"`
...
func (x *WriteRequestMeta_RecordMeta) GetSubCollection() config.Collection_SubCollectionType {
	if x != nil {
		return x.SubCollection
	}
	return config.Collection_SubCollectionType(0)
}
...
var file_contentwriter_v1_contentwriter_proto_rawDesc = []byte{
	...
	0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x28, 0x01, 0x42, 0x82, 0x01, 0x0a, 0x28, 0x6e, 0x6f, 0x2e,
	...
	0x69, 0x74, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x50, 0x01, 0x5a, 0x3e, 0x67,
	...
	0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x77, 0x72, 0x69, 0x74, 0x65, 0x72, 0x62, 0x06, 0x70,
...
var file_contentwriter_v1_contentwriter_proto_goTypes = []interface{}{
	...
	(config.Collection_SubCollectionType)(0), // 12: veidemann.api.config.v1.Collection.SubCollectionType
}
