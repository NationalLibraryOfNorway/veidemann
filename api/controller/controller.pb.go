...
type RoleList struct {
	...
	Role []config.Role `protobuf:"varint,1,rep,packed,name=role,proto3,enum=veidemann.api.config.v1.Role" json:"role,omitempty"`
}
...
func (x *RoleList) GetRole() []config.Role {
	if x != nil {
		return x.Role
	}
	return nil
...
var file_controller_v1_controller_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x79, 0x0a, 0x25, 0x6e, 0x6f,
	...
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x50, 0x01, 0x5a, 0x3b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x4e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x4c, 0x69, 0x62,
	0x72, 0x61, 0x72, 0x79, 0x4f, 0x66, 0x4e, 0x6f, 0x72, 0x77, 0x61, 0x79, 0x2f, 0x76, 0x65, 0x69,
	0x64, 0x65, 0x6d, 0x61, 0x6e, 0x6e, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x63, 0x6f, 0x6e, 0x74, 0x72,
...
var file_controller_v1_controller_proto_goTypes = []interface{}{
	...
	(config.Role)(0),                      // 6: veidemann.api.config.v1.Role
	(*emptypb.Empty)(nil),                 // 7: google.protobuf.Empty
	(*ExecutionId)(nil),                   // 8: veidemann.api.controller.v1.ExecutionId
	(*frontier.CrawlExecutionId)(nil),     // 9: veidemann.api.frontier.v1.CrawlExecutionId
	(*frontier.CrawlHostGroup)(nil),       // 10: veidemann.api.frontier.v1.CrawlHostGroup
	(*frontier.CrawlExecutionStatus)(nil), // 11: veidemann.api.frontier.v1.CrawlExecutionStatus
	(*frontier.JobExecutionStatus)(nil),   // 12: veidemann.api.frontier.v1.JobExecutionStatus
	(*frontier.CountResponse)(nil),        // 13: veidemann.api.frontier.v1.CountResponse
}
