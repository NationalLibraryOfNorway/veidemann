...
type ReportClient interface {
	...
	ListExecutions(ctx context.Context, in *CrawlExecutionsListRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[v1.CrawlExecutionStatus], error)
	// List a set of job executions
	ListJobExecutions(ctx context.Context, in *JobExecutionsListRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[v1.JobExecutionStatus], error)
}
...
func (c *reportClient) ListExecutions(ctx context.Context, in *CrawlExecutionsListRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[v1.CrawlExecutionStatus], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Report_ServiceDesc.Streams[1], Report_ListExecutions_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[CrawlExecutionsListRequest, v1.CrawlExecutionStatus]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Report_ListExecutionsClient = grpc.ServerStreamingClient[v1.CrawlExecutionStatus]

func (c *reportClient) ListJobExecutions(ctx context.Context, in *JobExecutionsListRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[v1.JobExecutionStatus], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Report_ServiceDesc.Streams[2], Report_ListJobExecutions_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[JobExecutionsListRequest, v1.JobExecutionStatus]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Report_ListJobExecutionsClient = grpc.ServerStreamingClient[v1.JobExecutionStatus]
...
type ReportServer interface {
	...
	// List a set of crawl executions
	ListExecutions(*CrawlExecutionsListRequest, grpc.ServerStreamingServer[v1.CrawlExecutionStatus]) error
	// List a set of job executions
	ListJobExecutions(*JobExecutionsListRequest, grpc.ServerStreamingServer[v1.JobExecutionStatus]) error
}
...
func (UnimplementedReportServer) ExecuteDbQuery(*ExecuteDbQueryRequest, grpc.ServerStreamingServer[ExecuteDbQueryReply]) error {
	return status.Error(codes.Unimplemented, "method ExecuteDbQuery not implemented")
}
func (UnimplementedReportServer) ListExecutions(*CrawlExecutionsListRequest, grpc.ServerStreamingServer[v1.CrawlExecutionStatus]) error {
	return status.Error(codes.Unimplemented, "method ListExecutions not implemented")
}
func (UnimplementedReportServer) ListJobExecutions(*JobExecutionsListRequest, grpc.ServerStreamingServer[v1.JobExecutionStatus]) error {
	return status.Error(codes.Unimplemented, "method ListJobExecutions not implemented")
}
...
func _Report_ListExecutions_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ReportServer).ListExecutions(m, &grpc.GenericServerStream[CrawlExecutionsListRequest, v1.CrawlExecutionStatus]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Report_ListExecutionsServer = grpc.ServerStreamingServer[v1.CrawlExecutionStatus]
...
func _Report_ListJobExecutions_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ReportServer).ListJobExecutions(m, &grpc.GenericServerStream[JobExecutionsListRequest, v1.JobExecutionStatus]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Report_ListJobExecutionsServer = grpc.ServerStreamingServer[v1.JobExecutionStatus]
